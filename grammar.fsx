...
let indexMap = keyToIndexMap grammar  |> Map.add "float" 6  |> Map.add "Sn" 2  |> Map.add "quotedstring" 7  |> Map.add "identifer_or_number" 4  |> Map.add "identifer" 3  |> Map.add "S" 1  |> Map.add "integer" 5
