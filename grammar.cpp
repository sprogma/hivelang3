...
new(array + 20)Rule(20, "Expr", vector<RuleVariant>{RuleVariant(vector<Atom>{"a", array + 21, "b"}, vector<Atom>{}, vector<Atom>{})});
new(array + 21)Rule(21, "Term", vector<RuleVariant>{RuleVariant(vector<Atom>{"t"}, vector<Atom>{}, vector<Atom>{}), RuleVariant(vector<Atom>{"v"}, vector<Atom>{}, vector<Atom>{})});
return array;
}